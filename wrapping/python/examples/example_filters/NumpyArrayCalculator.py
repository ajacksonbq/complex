...
class NumpyArrayCalculator:
  ...
  def uuid(self) -> nx.Uuid:
    ...
    :rtype: string
    """
    return nx.Uuid('95b1f641-581e-4047-b589-bf7c5821c9d4')
  ...
  def parameters(self) -> nx.Parameters:
    ...
    params.insert(nx.ChoicesParameter(NumpyArrayCalculator.OPERATION, 'NumPy Operations', '', 0, NumpyArrayCalculator.NUMPY_CHOICES_LIST))
    params.insert(nx.Parameters.Separator("Required Data Objects"))
    params.insert(nx.ArraySelectionParameter(NumpyArrayCalculator.INPUT_ARRAY_PATH, 'Input Array', '', nx.DataPath(), {nx.DataType.float32, nx.DataType.float64}, [[1]]))
    params.insert(nx.ArraySelectionParameter(NumpyArrayCalculator.INPUT_ARRAY_PATH_2, 'Input Array', '', nx.DataPath(), {nx.DataType.float32, nx.DataType.float64}, [[1]]))
    params.insert(nx.Parameters.Separator("Created Data Objects"))
    # params.insert(nx.ArrayCreationParameter(NumpyArrayCalculator.OUTPUT_ARRAY_KEY, 'Output Array', '', nx.DataPath([])))
    params.insert(nx.DataObjectNameParameter(NumpyArrayCalculator.OUTPUT_ARRAY_KEY, "Output Array Name", '', "Output Array"))
  ...
  def preflight_impl(self, data_structure: nx.DataStructure, args: dict, message_handler: nx.IFilter.MessageHandler, should_cancel: nx.AtomicBoolProxy) -> nx.IFilter.PreflightResult:
    ...
    input_array_paths: nx.DataPath = args[NumpyArrayCalculator.INPUT_ARRAY_PATH]
    input_array_paths_2: nx.DataPath = args[NumpyArrayCalculator.INPUT_ARRAY_PATH_2]
    # output_array_path: nx.DataPath = args[NumpyArrayCalculator.OUTPUT_ARRAY_KEY]
    output_array_name: str = args[NumpyArrayCalculator.OUTPUT_ARRAY_KEY]
    ...
    operation = args[NumpyArrayCalculator.OPERATION]
